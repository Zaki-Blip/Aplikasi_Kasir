...
class ProdukResource extends Resource
{
    ...
    public static function generateSku(Get $get, Set $set): void{
        $brand = Brand::find($get('brand'));
        $category = Category::find($get('category'));
        $subcategory = SubCategory::find($get('sub_category'));
        ...
        $sku = sprint('%s-%s-%s-$03d',$catCode,$subCode,$braCode,$nextNumber);
        $set
    }
